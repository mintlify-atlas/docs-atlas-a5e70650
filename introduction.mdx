...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="sliders" href="https://caddyserver.com/docs/caddyfile">
    Learn the Caddyfile syntax for easy configuration
  </Card>
  <Card title="API Reference" icon="code" href="https://caddyserver.com/docs/api">
...
<CardGroup cols={2}>
  ...
  <Card title="Learn Caddyfile" icon="book" href="https://caddyserver.com/docs/caddyfile">
    Master Caddy's configuration syntax
  </Card>
  <Card title="Explore Modules" icon="puzzle-piece" href="https://caddyserver.com/docs/modules/">
    Discover available modules and plugins
  </Card>
</CardGroup>
